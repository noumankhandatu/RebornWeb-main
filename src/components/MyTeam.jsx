...
const MyTeam = () => {
  ...
  useEffect(() => {
    ...
    const sw = standWork * 5.3;
    const ft = freqTravel * 10.6;
    const gt = glovalTror * 21.2;
  ...
  return (
    <section className="mx-auto my-4 flex flex-col items-center justify-center">
      <h2 className=" text-[16px] xsm:text-[20px] my-10 sm:text-[30px] text-center font-semibold font-poppins text-black-text">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 mdd:grid-cols-3 items-center justify-center gap-10 flex-wrap">
        <div
          ...
          className="min-h-[450px] rounded-sm hover:shadow-sm border px-4 mdd:px-9  gap-6 text-center py-10 shadow-sm bg-white flex items-center flex-col justify-center"
        >
          <Image
          ...
          <div>
            <h5 className="text-[20px]  text-white font-semibold" text-white>
              $5.30
            </h5>
            <p className="text-[12px]  text-white">Per employee per month</p>
          </div>
          <p className=" text-white text-[14px] font-worksans">
            Employee sometimes works from home and keeps travel to a minimum.
            This is the perfect package for employees that don&#39;t travel
            often for work.
          </p>

          <div className="flex px-2 border py-2 items-center justify-center gap-6  text-white">
            <p onClick={tandworkdes}>
              <FaMinus size={25} />
            </p>
            <p className="text-[22px] font-semibold  text-white">{standWork}</p>
            <p onClick={() => setStandWork(standWork + 1)}>
              <FaPlus size={25} />
            </p>
          </div>
        </div>
        ...
        <div className="min-h-[450px] border-4 border-green  rounded-lg hover:shadow-sm  px-4 mdd:px-9 gap-6 text-center py-10 shadow-sm bg-white flex items-center flex-col justify-center">
          ...
          <p className="text-black-text text-[14px] font-worksans">
            Employee has to occasionally travel for work, for example going to
            the office, events, or infrequent international meetings.
          </p>

          <div className="flex px-2 border py-2 items-center justify-center gap-6">
            <p onClick={freqtraveldec}>
              <FaMinus size={25} />
            </p>
            <p className="text-[22px] font-semibold">{freqTravel}</p>
            <p onClick={() => setFreqTravel(freqTravel + 1)}>
              <FaPlus size={25} />
            </p>
          </div>
        </div>
        ...
        <div className="rounded-lg min-h-[450px]  hover:shadow-sm border px-4 mdd:px-9 gap-6 text-center py-10 shadow-sm bg-green flex items-center flex-col justify-center">
          <Image
            ...
            alt="image"
          />
          <h3 className="  text-white text-[22px] font-semibold font-poppins ">
            Globe-trotter
          </h3>
          <div>
            <h5 className="text-[20px] font-semibold  text-white">$21.20</h5>
            <p className="text-[12px]   text-white">Per employee per month</p>
          </div>
          <p className=" text-[14px] font-worksans  text-white">
            Employee travels frequently for work, takes multiple flights per
            month and has a large carbon footprint.
          </p>
          ...
          <div className="flex px-2 border py-2 items-center justify-center gap-6  text-white">
            ...
            <p onClick={() => setGlobalTror(glovalTror + 1)}>
              <FaPlus size={25} />
            </p>
          </div>
        </div>
