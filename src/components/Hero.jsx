  ...
  return (
    <div className='relative w-full h-full'>
      ...
      <div className='w-[90%] max-w-[1440px] h-full ssm:w-[80%] flex-col mx-auto hero-content flex items-center gap-y-3 justify-center z-10'>
        <h1 className='text-[#ffffff] text-center font-worksans font-semibold text-sm ssm:text-lg xsm:text-[25px] sm:text-[35px] mdd:text-[50px] xlg:text-[60px] xll:text-[70px]'>Innovating, Supporting, and Engaging You in <span className='text-[#14a800]'>Climate </span>  Solutions</h1>
