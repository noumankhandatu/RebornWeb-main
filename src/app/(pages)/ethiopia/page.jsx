...
const page = () => {
    return (
        <div className='overflow-hidden h-full'>
            <div style={{ backgroundImage: "url('/assets/treeplanting-images/Ethiopia/1.png')" }} className=" flex-col   h-[95vh] flex items-center justify-center bg-cover w-full  px-[30px] relative lg:px-[60px] xll:px-[120px] py-[6rem] mx-auto">
                <motion.h3 initial={{ y: 200 }} viewport={{ once: true }} whileInView={{ y: 0 }} transition={{ duration: 0.5 }} className=' z-[1] leading-normal text-center lg:leading-[70px] xll:leading-[80px] text-[30px] sm:text-[50px] lg:text-[60px] xll:text-[65px] text-white font-medium font-worksans'><span className='text-white'>Ethiopia </span></motion.h3>
                    ...
                    <motion.div initial={{ y: 200, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ type: 'tween', duration: 0.5 }} className={`flex gap-15 flex-col lg:flex-row my-20 items-center justify-center`}>
                        <div className='  w-full mt-8 lg:mt-0 xsm:w-10/12 lg:flex-1  flex items-center justify-center flex-col'>
                            ...
                            <div className='w-full xsm:w-10/12 lg:flex-1 flex items-center text-center lg:text-start lg:items-start  justify-center flex-col'>
                                ...
                                <h3 className=' text-center lg:text-left mb-[20px] font-poppins text-[25px] xsm:text-[30px] lg:text-[35px] xll:text-[40px] font-[500] text-green'>Rebuilding Ethiopia &#39;s Forests</h3>
                                <p className='leading-[30px] text-sm sm:text-[16px]  font-worksans tracking-wide text-black-text'>Ethiopia, once known as the “Green Gold of Africa”, has faced significant deforestation challenges. This has led to soil erosion, decreased agricultural productivity, and reduced water availability. Our tree planting initiatives in Ethiopia focus on restoring native forests, improving soil health, and promoting sustainable land management practices for a more resilient future.</p>
                            </div>

                        </div>
                        <Image src='/assets/treeplanting-images/Ethiopia/2.png' width={700} height={600} alt='bussnessec2' loading='lazy' className=' rounded-lg w-full sm:w-[80%] mdd:w-[50%] h-auto' />
            ...
            <section className='w-full bg-white mt-10 max-w-[1800px] mb-[60px]  px-[30px] lg:px-[60px] xll:px-[120px] py-[4rem] mx-auto'>
                <h1 className='text-center mb-[20px] font-poppins text-[30px] xsm:text-[40px] lg:text-[50px] xll:text-[55px] font-[500] text-[#3d3d3d]'>
                    <span className='font-semibold text-[#14a800]'>Why Restore in Ethiopia ?</span>
                </h1>
            ...
            <section className='bg-[#f6f6f6]'>
                <section className='w-full flex items-center justify-start flex-col   max-w-[1800px]  px-[30px] lg:px-[60px] xll:px-[120px] py-[4rem] mx-auto'>
                    <motion.div initial={{ y: 200 }} viewport={{ once: true }} whileInView={{ y: 0 }} transition={{ duration: 0.5 }} className='w-full flex flex-col items-center justify-center'>
                        <h1 className='text-center mb-[20px] font-poppins text-[30px] xsm:text-[35px] lg:text-[50x] xll:text-[55px] font-[500] text-[#3d3d3d]'>Reforestation and Livelihood Support in Shebedino Community
                    ...
                    <motion.div initial={{ y: 200, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ type: 'tween', duration: 0.5 }} className='flex gap-28 flex-col lg:flex-row my-20 items-center justify-center'>
                        ...
                        <Image src="/assets/treeplanting-images/Ethiopia/6.png" width={800} height={600} alt='bussnessec2' loading='lazy' className=' rounded-lg w-full sm:w-[80%] mdd:w-[50%] h-auto' />
                    </motion.div>
