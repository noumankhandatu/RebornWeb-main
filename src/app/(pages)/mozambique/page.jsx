...
const textcardData = [
    {
        image: '/assets/treeplanting-images/Mozambique/20190822_Mozambique_0333.jpg',
    ...
    {
        image: '/assets/treeplanting-images/Mozambique/20190822_Mozambique_0423wm.jpg',
    ...
    {
        image: 'https://reborngreen.co.uk/wp-content/uploads/2024/05/Untitled-design-2024-05-02T135031.066.png',
...
const page = () => {
    return (
        <div className='overflow-hidden h-full'>
            ...
            <div style={{ backgroundImage: "url('/assets/treeplanting-images/Mozambique/green123.png')" }} className=" flex-col   h-[95vh] flex items-center justify-center bg-cover w-full  px-[30px] relative lg:px-[60px] xll:px-[120px] py-[6rem] mx-auto">
                <motion.h3 initial={{ y: 200 }} viewport={{ once: true }} whileInView={{ y: 0 }} transition={{ duration: 0.5 }} className=' z-[1] leading-normal text-center lg:leading-[70px] xll:leading-[80px] text-[30px] sm:text-[50px] lg:text-[60px] xll:text-[65px] text-white font-medium font-worksans'><span className='text-white'>Mozambique </span></motion.h3>
                    ...
                    <motion.div initial={{ y: 200, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ type: 'tween', duration: 0.5 }} className={`flex gap-15 flex-col lg:flex-row my-20 items-center justify-center`}>
                        <div className='  w-full mt-8 lg:mt-0 xsm:w-10/12 lg:flex-1  flex items-center justify-center flex-col'>
                            ...
                            <div className='w-full xsm:w-10/12 lg:flex-1 flex items-center text-center lg:text-start lg:items-start  justify-center flex-col'>
                                <h3 className=' text-center lg:text-left mb-[20px] font-poppins text-[25px] xsm:text-[30px] lg:text-[35px] xll:text-[40px] font-[700] text-green'>Trees for Coastal Defenses</h3>
                                <p className='leading-[30px] text-sm sm:text-[16px]  font-worksans tracking-wide text-black-text'>Mozambique’s long coastline is vital to its economy and culture. However, deforestation has led to increased soil erosion and weakened coastal defenses, making communities more vulnerable to cyclones and floods. The tree planting projects in Mozambique focus on restoring coastal mangrove forests, which act as natural barriers against storms and provide vital nursery grounds for marine life.</p>
                            </div>

                        </div>
                        <Image src='/assets/treeplanting-images/Mozambique/20190822_Mozambique_0347wm.jpg' width={700} height={600} alt='bussnessec2' loading='lazy' className=' rounded-lg w-full sm:w-[80%] mdd:w-[50%] h-auto' />
            ...
            <section className='w-full bg-white mt-10 max-w-[1800px] mb-[60px]  px-[30px] lg:px-[60px] xll:px-[120px] py-[4rem] mx-auto'>
                <h1 className='text-center mb-[20px] font-poppins text-[30px] xsm:text-[40px] lg:text-[50px] xll:text-[55px] font-[500] text-[#3d3d3d]'>
                    <span className='font-bold text-green'>Why Planting Trees in Mozambique?</span>
                </h1>
            ...
            <section className='bg-[#f6f6f6]'>
                <section className='w-full flex items-center justify-start flex-col   max-w-[1800px]  px-[30px] lg:px-[60px] xll:px-[120px] py-[4rem] mx-auto'>
                    <motion.div initial={{ y: 200 }} viewport={{ once: true }} whileInView={{ y: 0 }} transition={{ duration: 0.5 }} className='w-full flex flex-col items-center justify-center'>
                        <h1 className='text-center mb-[20px] font-poppins text-[30px] xsm:text-[35px] lg:text-[50x] xll:text-[55px] font-[500] text-green'>Coastal Restoration</h1>
                    </motion.div>
                    <motion.div initial={{ y: 200, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ type: 'tween', duration: 0.5 }} className='flex gap-28 flex-col lg:flex-row my-20 items-center justify-center'>
                        ...
                        <Image src='/assets/treeplanting-images/Mozambique/Mozambiquemangroves.jpg' width={800} height={600} alt='bussnessec2' loading='lazy' className=' rounded-lg w-full sm:w-[80%] mdd:w-[50%] h-auto' />
                    </motion.div>
