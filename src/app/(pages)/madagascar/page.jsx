...
const textcardData = [
  {
    image: 'https://reborngreen.co.uk/wp-content/uploads/2024/04/Untitled-design-2024-04-24T193421.241.png',
...
const page = () => {
  return (
    <div className='overflow-hidden h-full'>
      ...
      <div style={{ backgroundImage: "url('https://reborngreen.co.uk/wp-content/uploads/2024/04/Untitled-design-2024-04-23T203141.122.png')" }} className=" flex-col   h-[95vh] flex items-center justify-center bg-cover w-full  px-[30px] relative lg:px-[60px] xll:px-[120px] py-[6rem] mx-auto">
      ...
      <section className='bg-white'>
        <div className='w-full max-w-[1800px] my-[40px]   px-[30px] lg:px-[60px] xll:px-[120px] py-[2rem] mx-auto'>
          ...
          <motion.div initial={{ y: 200, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ type: 'tween', duration: 0.5 }} className={`flex gap-15 flex-col lg:flex-row my-20 items-center justify-center`}>
            ...
            <Image src='/assets/treeplanting-images/Madadascar/IMG_7142.jpg' width={700} height={600} alt='bussnessec2' loading='lazy' className=' rounded-lg w-full sm:w-[80%] mdd:w-[50%] h-auto' />
        ...
        <div className='flex gap-6 flex-wrap items-center justify-center'>
          {
            textcardData?.map((item, index) => (
              <div key={index} style={{
                ...
                className=" w-full xsm:w-[90%] flex items-end relative bg-cover bg-no-repeat justify-between  duration-500 hover:scale-110 md:w-[48%] xlg:w-[30%] xll:w-[30%] h-full rounded-xl shadow-lg border min-h-[520px]">
